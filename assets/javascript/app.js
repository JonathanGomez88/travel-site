...
function oneWayDisplay(results) {
    ...
    for (let i = 0; i < resultsArray.length; i++) {
     for (let y = 0; y < resultsArray[i].itineraries.length; y++) {
        ...
        $("#flight-display > tbody").prepend("<tr><td>$" + flightFare + "</td><td>" + "Placeholder" + "</td><td>" + destinationAirport + "</td><td>" + flightNumberOut + outboundArrivalDate.format("MM/DD/YYYY") + "</td><td>" + outboundArrivalDate.format("hh:mm a") + "<br>" + "(" + outboundDurationDisplay + ")" + "</td><td>" + "NA" + "<tr><td>" + "N/A" + "</td><td>" + "N/A" + "</td><td>" + "N/A" + "</td></tr>")
